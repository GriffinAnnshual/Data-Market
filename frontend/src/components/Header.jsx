				...
				{isAuthenticated ? (
					...
					<>
						<div className="relative group">
							<div className="px-4 py-2 text-xl text-blue-500 cursor-pointer font-bold bg-white">
								Dashboard
							</div>
							<div className="bg-white text-blue-500 font-bold  p-2 absolute z-10 px-[9%] pr-[17%] hidden group-hover:block">
